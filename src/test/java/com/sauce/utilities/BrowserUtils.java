...
public class BrowserUtils {
    ...
    public static WebElement waitForVisibility(WebElement element, int timeToWaitInSec) {
        ...
        //WebDriverWait wait = new WebDriverWait(Driver.get(), Duration.ofSeconds(20)); // use this is Selenium 4.
     ...
     *
     * @param locator findByElement locator type
     ...
     *
     * @param timeOutInSeconds seconds
     */
